...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?> Konfigurasi banner <?php $__env->endSlot(); ?>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <input id="title" name="title" type="text" class="form-control"
                                    placeholder="Enter Project Name..." value="<?php echo e($banner->title); ?>" >
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <input id="link" name="link" type="text" class="form-control"
                                    placeholder="Enter Project Name..." value="<?php echo e($banner->link); ?>" >
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <img class="rounded me-2" alt="200x200" src="/image/<?php echo e($banner->gambar); ?>" data-holder-rendered="true" width="200">
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel-real\coba\resources\views/panel/banner/edit.blade.php ENDPATH**/ ?>