                                ...
                                <div class="card">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-5 text-center">
                                                <img class="rounded me-2" alt="Logo" src="/image/<?php echo e($whitelabel->footer_logo); ?>" data-holder-rendered="true" height="100">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="instagram" class="form-control" id="inlineFormInputGroupUsername" placeholder="link G" value="<?php echo e($whitelabel->instagram); ?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="input-group">
                                                    <div class="input-group-text"><i class=" bx bxl-twitter "></i></div>
                                                    <input type="text" name="twitter" class="form-control" id="inlineFormInputGroupUsername" placeholder="link TWT" value="<?php echo e($whitelabel->twitter); ?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="input-group">
                                                    <div class="input-group-text"><i class=" bx bxl-facebook "></i></div>
                                                    <input type="text" name="facebook" class="form-control" id="inlineFormInputGroupUsername" placeholder="link FB" value="<?php echo e($whitelabel->facebook); ?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="input-group">
                                                    <div class="input-group-text"><i class="bx bxl-youtube "></i></div>
                                                    <input type="text" name="youtube" class="form-control" id="inlineFormInputGroupUsername" placeholder="link YT" value="<?php echo e($whitelabel->youtube); ?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="input-group">
                                                    <div class="input-group-text"><i class="bx bxl-youtube "></i></div>
                                                    <input type="text" name="tiktok" class="form-control" id="inlineFormInputGroupUsername" placeholder="link TT" value="<?php echo e($whitelabel->tiktok); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
