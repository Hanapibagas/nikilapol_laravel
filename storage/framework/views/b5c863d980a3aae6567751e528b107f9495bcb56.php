        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('syarat-details.update', $mersyaratdetail->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <input id="title" name="title" type="text" class="form-control"
                                    placeholder="Enter Project Name..." value="<?php echo e($mersyaratdetail->title); ?>" >
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <textarea id="description" name="description" type="text" class="form-control" style="height:100px;"
                                    placeholder="Enter Project Name..."><?php echo e($mersyaratdetail->description); ?></textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <img class="rounded me-2" alt="200x200" src="/image/<?php echo e($mersyaratdetail->gambar); ?>" data-holder-rendered="true" width="200">
                            </div>
                        </div>
