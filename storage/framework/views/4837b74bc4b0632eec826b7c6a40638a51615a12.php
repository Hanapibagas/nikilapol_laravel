                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <input id="title" name="title" type="text" class="form-control"
                                    placeholder="Enter Project Name..." value="<?php echo e($header->title); ?>" >
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <textarea id="description" name="description" type="text" class="form-control" style="height:100px;"
                                    placeholder="Enter Project Name..."><?php echo e($header->description); ?></textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <input id="link" name="link" type="text" class="form-control"
                                    placeholder="Enter Project Name..." value="<?php echo e($header->link); ?>" >
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <img class="rounded me-2" alt="200x200" src="/image/<?php echo e($header->aplikasi); ?>" data-holder-rendered="true" width="200">
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-5 text-center">
                            <img class="rounded me-2" alt="200x200" src="/image/<?php echo e($header->cover); ?>" data-holder-rendered="true" width="200">
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel-real\coba\resources\views/panel/header/edit.blade.php ENDPATH**/ ?>