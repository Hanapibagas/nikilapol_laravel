    ...
    <section class="c-section container-fluid c-top-faq">
        <div class="container">
            ...
            <div class="row">
                ...
                <a href="<?php echo e(route('details', $faq->slug)); ?>" class="col-md-6 col-12 pr-md-2 mb-12px mb-md-3">
                            ...
                            <a href="./niki_belanjain/niki_belanjain.html">
                                <div class="c-category c-category__item c-category__hover--down-high row">
                                    <div class="c-category__icon">
                                        <img src="/image/<?php echo e($logistic->gambar); ?>"" class="lazy" alt="belanjain icon">
