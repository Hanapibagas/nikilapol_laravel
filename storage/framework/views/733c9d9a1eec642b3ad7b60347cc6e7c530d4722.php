        ...
        <div class="card">
            ...
            <?php if($message = Session::get('success')): ?>
                ...
                <div class="d-flex flex-wrap mb-2">
                    <a href="<?php echo e(route('merctutor.create')); ?>" type="button" class="btn btn-success waves-effect btn-label waves-light mb-2"><i class="bx bx-add-to-queue label-icon"></i>Tambah Data</a>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="<?php echo e(route('merctutor.destroy',$merctutor->id)); ?>" method="POST">
                                        <a class="btn btn-primary waves-effect btn-label waves-light btn-sm" href="<?php echo e(route('merctutor.edit',$merctutor->id)); ?>"><i class="bx bx-edit  label-icon"></i>Edit</a>
                                        <?php echo csrf_field(); ?>
