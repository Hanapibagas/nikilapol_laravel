        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('profit.update', $profit->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <input id="title" name="title" type="text" class="form-control"
                                    placeholder="Enter Project Name..." value="<?php echo e($profit->title); ?>" >
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <textarea id="description" name="description" type="text" class="form-control" style="height:100px;"
                                    placeholder="Enter Project Name..."><?php echo e($profit->description); ?></textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <img class="rounded me-2" alt="200x200" src="/image/<?php echo e($profit->gambar); ?>" data-holder-rendered="true" width="200">
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel-real\coba\resources\views/panel/profit/edit.blade.php ENDPATH**/ ?>