        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap mb-2">
                    <a href="<?php echo e(route('banner.create')); ?>" type="button" class="btn btn-success waves-effect btn-label waves-light mb-2"><i class="bx bx-add-to-queue label-icon"></i>Tambah Data</a>
                </div>
                    ...
                    <table class="table align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="/image/<?php echo e($banner->gambar); ?>" class="rounded me-2" data-holder-rendered="true" width="100"></td>
                                <td>
                                    <form action="<?php echo e(route('banner.destroy',$banner->id)); ?>" method="POST">
                                        <a class="btn btn-primary waves-effect btn-label waves-light btn-sm" href="<?php echo e(route('banner.edit',$banner->id)); ?>"><i class="bx bx-edit  label-icon"></i>Edit</a>
                                        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\saefu\Downloads\source-code-cms-nikila\coba\resources\views/panel/banner/index.blade.php ENDPATH**/ ?>