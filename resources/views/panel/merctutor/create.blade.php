...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @slot('title') Tambah tutor @endslot
    @endcomponent
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('merctutor.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-4">
                        ...
                        <div class="row mb-4">
                            <label for="description" class="col-form-label col-lg-2">Link</label>
                            <div class="col-lg-10">
                                <input id="link" name="description" type="text" class="form-control"
                                    placeholder="isikan desckripsi..." >
                                    @error('description')
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                     @enderror
                            </div>
