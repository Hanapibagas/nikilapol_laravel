        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('syarat-reward.update', $drevsyaratheader->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
