...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?> Konfigurasi About Us <?php $__env->endSlot(); ?>
    <?php echo $__env->renderComponent(); ?>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Konfigurasi About Us</h4>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <input id="title" name="title" type="text" class="form-control"
                                    placeholder="Enter Project Name..." value="<?php echo e($about->title); ?>" >
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <textarea id="description" name="description" type="text" class="form-control" style="height:100px;"
                                    placeholder="Enter Project Name..."><?php echo e($about->description); ?></textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <input id="youtube" name="youtube" type="text" class="form-control"
                                    placeholder="Masukan link youtube" value="<?php echo e($about->youtube); ?>" >
                            </div>
                        </div>
                        <div class="row mb-4">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel-real\coba\resources\views/panel/about/edit.blade.php ENDPATH**/ ?>