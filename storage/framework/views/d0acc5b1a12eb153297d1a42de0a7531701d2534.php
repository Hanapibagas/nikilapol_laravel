...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?> Edit Artikel <?php $__env->endSlot(); ?>
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('blog.update', $blog->id)); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <input id="title" name="title" type="text" class="form-control" placeholder="Nama judul..." value="<?php echo e($blog->title); ?>" >
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <input id="slug" name="slug" type="text" class="form-control"
                                    placeholder="isikan slug..." value="<?php echo e($blog->slug); ?>" >
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <input id="category" name="category" type="text" class="form-control"
                                    placeholder="isikan category..." value="<?php echo e($blog->category); ?>" >
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <textarea id="editor" name="description" type="text"><?php echo $blog->description; ?></textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\saefu\Downloads\source-code-cms-nikila\coba\resources\views/panel/blog/edit.blade.php ENDPATH**/ ?>