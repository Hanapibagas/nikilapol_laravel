                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="<?php echo e(route('mercbanner.destroy',$mercbanner->id)); ?>" method="POST">
                                        <a class="btn btn-primary waves-effect btn-label waves-light btn-sm" href="<?php echo e(route('mercbanner.edit',$mercbanner->id)); ?>"><i class="bx bx-edit  label-icon"></i>Edit</a>
                                        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel-real\coba\resources\views/panel/mercbanner/index.blade.php ENDPATH**/ ?>