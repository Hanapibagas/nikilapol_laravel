        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap mb-2">
                    <a href="{{ route('profit.create') }}" type="button" class="btn btn-success waves-effect btn-label waves-light mb-2"><i class="bx bx-add-to-queue label-icon"></i>Tambah Data</a>
                </div>
