                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <input id="title" name="title" type="text" class="form-control"
                                    placeholder="Enter Title..." value="<?php echo e($mercbanner->title); ?>" >
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <input id="description" name="description" type="text" class="form-control"
                                    placeholder="Enter description..." value="<?php echo e($mercbanner->description); ?>" >
                            </div>
                        </div>
                        <div class="row mb-4">
