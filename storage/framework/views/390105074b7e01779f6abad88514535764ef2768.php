                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input id="title_header" name="title_header" type="text" class="form-control" value="<?php echo e($header->title); ?>" >
                            </div>
                            <div class="mb-3">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel-real\coba\resources\views/panel/edit.blade.php ENDPATH**/ ?>