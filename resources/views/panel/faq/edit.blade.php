                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('faq.update', $faq->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <input id="title" name="title" type="text" class="form-control" placeholder="Nama judul..." value="{{ $faq->title }}" >
                                @error('title')
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <input id="slug" name="slug" type="text" class="form-control"
                                    placeholder="isikan slug..." value="{{ $faq->slug }}" >
                                    @error('slug')
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                     @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <input id="category" name="category" type="text" class="form-control"
                                    placeholder="isikan category..." value="{{ $faq->category }}" >
                                    @error('category')
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                     @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <textarea id="editor" name="description" type="text">{!! $faq->description !!}</textarea>
                            </div>
                        </div>
