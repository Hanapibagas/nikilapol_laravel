                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('profit.store')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <img class="rounded me-2" alt="200x200" src="/assets/images/preview.png" data-holder-rendered="true" width="200">
                            </div>
                        </div>
