        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('driver-benefit.update', $drivbanefit->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        <div class="row mb-4">
                            <label for="title" class="col-form-label col-lg-2">Title</label>
                            <div class="col-lg-10">
                                <input id="title" name="title" type="text" class="form-control" placeholder="Nama judul..." value="<?php echo e($drivbanefit->title); ?>">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="description" class="col-form-label col-lg-2">Description</label>
                            <div class="col-lg-10">
                                <input id="description" name="description" type="text" class="form-control" placeholder="Nama judul..." value="<?php echo e($drivbanefit->description); ?>">
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <img class="rounded me-2" id="gambar-view" alt="200x200" src="/image/<?php echo e($drivbanefit->gambar); ?>" data-holder-rendered="true" width="200">
                            </div>
                        </div>
