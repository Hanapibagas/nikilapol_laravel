        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('driver-banner.update', $drivbanner->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        <div class="row mb-4">
                            <label for="title" class="col-form-label col-lg-2">Title</label>
                            <div class="col-lg-10">
                                <input id="title" name="title" type="text" class="form-control" placeholder="Nama judul..." value="<?php echo e($drivbanner->title); ?>" >
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <textarea id="description" name="description" type="text" class="form-control" style="height:100px;"
                                    placeholder="Enter Project Name..."><?php echo $drivbanner->description; ?></textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-5 text-center">
                                <img class="rounded me-2" alt="200x200" src="/image/<?php echo e($drivbanner->gambar); ?>" data-holder-rendered="true" width="200">
                            </div>
                        </div>
