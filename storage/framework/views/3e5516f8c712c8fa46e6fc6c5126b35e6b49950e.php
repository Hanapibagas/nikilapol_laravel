...
<html class="wide wow-animation" lang="en">
  <head>
    <title>NikiLa POL | Beranda</title>
    <meta charset="utf-8">
    ...
    <meta property="og:description" content="www.NikiLa-POL.com" />
    <meta property="og:url" content="https://ezazee.github.io/NikiLa-POL/" />
    <meta property="og:image" content="assets/img/banner/Banner Tentang NikiLaPOL.jpg"/>


    <!-- Open Graph / Facebook -->
<meta property="og:type" content="assets/img/banner/Banner Tentang NikiLaPOL.jpg">
...
<!-- Twitter -->
<meta property="twitter:card" content="assets/img/banner/Banner Tentang NikiLaPOL.jpg">
...
<meta property="twitter:image" content="assets/img/banner/Banner Tentang NikiLaPOL.jpg">
  ...
  <body>
              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <div class="rd-navbar-brand">
                    <!--Brand--><a class="brand" href="index.html"><img class="brand-logo-dark" src="/home/assets/img/logo/Logo NIKILA_Lamongan POL.png" alt="" width="181" height="45"/><img class="brand-logo-light" src="/home/assets/img/logo/Logo NIKILA_Lamongan POL.png" alt="" width="181" height="45"/></a>
                  </div>
                </div>
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    <ul class="rd-navbar-nav">
                      <li class="rd-nav-item"><a class="rd-nav-link" href="html/tentang/tentang.html">Tentang NikiLa POL</a>
                      </li>
            ...
            <div class="row row-40 align-items-center wow fadeInUp">
              <div class="col-xl-7 col-lg-6">
                <div class="img-video">
                  ...
                  <img class="box-shadow" src="/image/<?php echo e($about->gambar); ?>" alt="" width="660" height="406"/>
                </div>
              </div>
              <div class="col-xl-5 col-lg-6">
                <h6>Tentang</h6>
                <h2 style="font-family: 'Roboto' ; font-size: 50px;
                ">Apa itu <span style="color: #1293E4;"> NikiLa POL</span></h2>
    ...
    <div class="container wow fadeInUp">
      <h2 class="my-5 text-center" style="font-family: 'Poppins';"> <span style="color: #1293E4;">Fasilitas</span> Yang Kami Sajikan</h2>
  ...
  <!-- End Banner -->
        ...
        <section class="section section-md bg-default">
          <div class="container">
            <div class="row row-15 justify-content-sm-between wow fadeInUp">
              <div class="col-xl-5 col-lg-6">
                <h6>Kenapa Harus NikiLa POL ?</h6>
                <h2 style="font-family: 'Poppins'; font-size: 40px;"><?php echo e($profit->title); ?></h2>
        ...
        <section class="section section-md bg-default" id="what-we-do">
          <div class="container">
            <div class="text-center wow fadeInUp">
              ...
              <h2 style="font-family: 'Poppins';">Jasa yang bisa nemenin hari hari mu</h2>
            </div>
        ...
        <div class="container">
          <div class="row row-50 align-items-center flex-xl-row-reverse justify-content-center wow fadeInUp">
            <div class="col-xl-5 col-lg-8 col-md-9 text-center text-xl-left">
              ...
              <h2 style="font-family: 'Poppins';">Kategori Layanan</h2>
            ...
            <div class="col-xl-7 col-lg-9">
              <ul class="list-brands">
                ...
                <li class="list-brands-item"><a class="list-brands-link" href="#"><img class="list-brands-img" src="/image/<?php echo e($category->gambar); ?>" alt="" width="50" height="71"/></a></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </ul>
            </div>
          </div>
      ...
      <section class="section section-md bg-default">
         <div class="text-center wow fadeInUp pb-5">
              <h6>Mitra</h6>
              <h2 style="font-family: 'Poppins';">Gabung Bersama Kami</h2>
            </div>
            <div class="row">
                <a class="card2" href="#">
                      <img src="/home/assets/img/Icon Mitra/Mitra Driver.png" width="80px" alt="">
                <h3 style="font-family: 'Poppins';">Mitra Driver</h3>
                ...
                <a class="card2" href="#">
                   <img src=".//home/assets/img/Icon Mitra/Mitra Merchant.png" width="80px" alt="">
                <h3 style="font-family: 'Poppins';">Mitra Merchant</h3>
  ...
  <div class="slides">
    <article  class="main-post main-post--active">
      <div class="main-post__image">
        <img src="/home/assets/img/banner/Banner Mitra Driver.jpg" alt="New McLaren wind tunnel 'critical' to future performance, says Tech Director Key" />
      </div>
      <div class="main-post__content">
        <div class="main-post__tag-wrapper">
          <span class="main-post__tag">Berita Artikel</span>
        </div>
        <h1 class="main-post__title">Menjadi Pahlawan Keluarga Dengan Menjadi Mitra Driver NikiLa POL</h1>
    ...
    <article class="main-post main-post--not-active">
      <div class="main-post__image">
        <img src="/home/assets/img/banner/Banner Mitra Merchant.jpg" alt="What To Watch For in the 2019 Hungarian Grand Prix" />
      </div>
      <div class="main-post__content">
        <div class="main-post__tag-wrapper">
          <span class="main-post__tag">Berita Video</span>
        </div>
        <h1 class="main-post__title">NuKu merilis Video Baru Nya Di Youtube</h1>
        <a class="main-post__link" href="https://youtu.be/trb7WSUwHA8" data-lightgallery="item">
              <svg
              ...
              <span class="main-post__link-text">Putar Viideo</span>
            </a>
      </div>
    </article>
    <article class="main-post main-post--not-active">
      <div class="main-post__image">
        <img src="/home/assets/img/banner/Banner Tentang NikiLaPOL.jpg" alt="Hamilton wants harder championship fight from Leclerc and
            Verstappen" />
      </div>
      <div class="main-post__content">
        <div class="main-post__tag-wrapper">
        ...
        <h1 class="main-post__title">Lamongan Resmi Merilis Aplikasi NikiLa POL Secara Keseluruhan di Kabupaten Lamongan
        </h1>
        <a class="main-post__link" href="#">
              <span class="main-post__link-text">Selengkapnya</span>
              <svg
...
<div class="posts-wrapper hide-on-mobile">
  <article onclick="location.href='#' " style="cursor: pointer;" class="post post--active">
    ...
    <h2 class="post__title">Menjadi Pahlawan Keluarga Dengan Menjadi Mitra Driver NikiLa POL</h2>
  </article>
  <article onclick="location.href='#' " style="cursor: pointer;" class="post">
    <div class="progress-bar">
      <div class="progress-bar__fill"></div>
    </div>
    <header class="post__header">
      <span class="post__tag">Berita Video</span>
      <p class="post__published">12 August 2019</p>
    </header>
    <h2 class="post__title">NuKu merilis Video Baru Nya Di Youtube</h2>
  </article>
  <article onclick="location.href='#' " style="cursor: pointer;" class="post">
    <div class="progress-bar">
      <div class="progress-bar__fill"></div>
    ...
    <header class="post__header">
      <span class="post__tag">Berita Artkel</span>
      <p class="post__published">08 August 2019</p>
    </header>
    <h2 class="post__title">Lamongan Resmi Merilis Aplikasi NikiLa POL Secara Keseluruhan di Kabupaten Lamongan
    </h2>
  </article>
</div>
</div>
            ...
            <div class="container">
                <div class="row-footer">
                    <div class="logo-bottom">
                        <img src="./assets/img/logo/Logo NIKILA_Lamongan POL.png" alt="NikiLa" title="NikiLa">
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box-footer1">
                                <div class="footer-text">
                                    NikiLa Pasar Online Lamongan atau yang disingkat NikiLa POL adalah Super Apps yang menggabungkan Marketplace dan Delivery Order, yang mempunyai tujuan menjadi wadah jualan produk kearifan lokal Kabupaten Lamongan serta untuk meningkatkan PAD (Pendapatan Asli Daerah) Kabupaten.
                                </div>
                        ...
                        <div class="col-md-2">
                            <div class="box-footer2">
                                ...
                                <ul class="list1 pt-4">
                                    ...
                                    <li><a href="html/tentang/tentang.html" title="">Tentang NikiLa POL</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="box-footer3">
                                ...
                                <ul class="list1 pt-4">
                                    <li><i class="fas fa-envelope"></i>support@nikilapol.com</li>
                    ...
                    <div class="box-copy">
                        &copy; 2022. <b>NikiLa POL</b>. All Rights Reserved
                    </div>
                  <div class="img-nuku">
                    <img src="./assets/img/Powered by NuKu.png" width="150px" alt="">
                  </div>
                </div>
            </div>
        </footer>
...
</html><?php /**PATH D:\laravel-real\coba\resources\views/landing.blade.php ENDPATH**/ ?>