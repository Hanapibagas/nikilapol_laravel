                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <input id="title" name="title" type="text" class="form-control"
                                    placeholder="Enter Project Name..." value="{{ $banner->title }}" >
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <input id="link" name="link" type="text" class="form-control"
                                    placeholder="Enter Project Name..." value="{{ $banner->link }}" >
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <img class="rounded me-2" alt="200x200" src="/image/{{$banner->gambar}}" data-holder-rendered="true" width="200">
                            </div>
                        </div>
