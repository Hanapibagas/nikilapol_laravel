        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('syarat-detail.update', $drevsyaratdetail->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <input id="title" name="title" type="text" class="form-control"
                                    placeholder="Enter Project Name..." value="{{ $drevsyaratdetail->title }}" >
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <img class="rounded me-2" alt="200x200" src="/image/{{$drevsyaratdetail->gambar}}" data-holder-rendered="true" width="200">
                            </div>
                        </div>
